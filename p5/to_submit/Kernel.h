...
----------------------------------------------------------------
  ...
  class ThreadManager
    ...
    fields
      ...
      threadManagerLock: Mutex                                  -- mutex lock to the ThreadManager class 
      aThreadBecameFree: Condition                              -- condition variable to the ThreadManager class
      --threadCheck : Mutex
      --hreadFree : Condition
    methods
      Init ()
